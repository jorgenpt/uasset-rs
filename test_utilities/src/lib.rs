...
const LATEST_UE5_MINOR_VERSION: u32 = 5;
...
#[case::ue_5_5(test_utilities::UnrealVersionInfo::ue5(
    5,
    test_utilities::ObjectVersionUE5::ASSETREGISTRY_PACKAGEBUILDDEPENDENCIES
))]
